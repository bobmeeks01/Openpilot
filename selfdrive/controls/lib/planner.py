...
# Bob - lower top end acceleration.  Increase low end.
# Also make non-following the same as following per Kegman
# _A_CRUISE_MAX_V = [1.2, 1.2, 0.65, .4]
# _A_CRUISE_MAX_V_FOLLOWING = [1.6, 1.6, 0.65, .4]
# _A_CRUISE_MAX_BP = [0.,  6.4, 22.5, 40.]

_A_CRUISE_MAX_V = [1.9, 1.2, 0.55, .28]
_A_CRUISE_MAX_V_FOLLOWING = [1.9, 1.2, 0.55, .28]
_A_CRUISE_MAX_BP = [0.,  6.4, 21.5, 33.]
